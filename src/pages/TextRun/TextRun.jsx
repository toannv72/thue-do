    ...
    return (
        <div className={cx('div')}>
            <marquee className={cx('running-text')}>
                <p>
                    Web thuê đồ là một trang web cung cấp dịch vụ cho thuê trang phục và đồ dùng cho các sự kiện như
                    cưới hỏi, sinh nhật, lễ kỷ niệm, tiệc tùng và các sự kiện khác. Trang web cung cấp nhiều loại trang
                    phục và đồ dùng khác nhau, đảm bảo mang đến sự lựa chọn đa dạng và phù hợp với nhu cầu của khách
                    hàng.
                </p>
                <p>
